...
void Graph::puertoMax(){
    ...
    mayor=puertos[0].getMax(puertos);

    cout<<"El puerto mas atacado es "<<mayor.getName()<<" con "<< mayor.getSize()<<" ataques"<<endl;
...
void Graph::IPMax(){
    ...
    mayor=IPs[0].getMax(IPs);

    cout<<"El IP con mas recorrido es "<<mayor.getName()<<" con "<< mayor.getSize()<<" recorridos"<<endl;
